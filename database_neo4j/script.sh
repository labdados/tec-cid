...
cat cria_relacionamento_filiado_a.cypher | cypher-shell -u neo4j -p tcctcc --format plain
cat cria_relacionamento_doapara.cypher | cypher-shell -u neo4j -p tcctcc 